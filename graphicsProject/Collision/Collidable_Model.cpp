...
Collidable_Model::Collidable_Model(void)
{
}
...
void Collidable_Model::Set_BoundingBox(Bounding_Box fBoundingBox)
{
	boundingBox = fBoundingBox;
}

Bounding_Box Collidable_Model::Get_BoundingBox()
{
	return boundingBox;
}

Bounding_Box Collidable_Model::CalculateBoundingBox(std::vector<glm::vec3> vertices, float boxOffset /*= 0.0f*/)
{
...
void Collidable_Model::Collided()
{
